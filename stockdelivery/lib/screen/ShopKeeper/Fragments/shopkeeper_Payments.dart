...
import 'package:stockdelivery/screen/ShopKeeper/ShpkeeperCredit/Notificationsss.dart';

import '../../../methods/apicalling.dart';
import '../../../models/signin.dart';
import '../../../mywidget/Mywidget.dart';
import '../../../mywidget/show_Rating.dart';
import '../../Distributor/Distributor_credit/CreditOrder_details.dart';
import '../../Vendor/Credit_management/payments_details.dart';
import '../ShpkeeperCredit/shopkeeper_creditOrders.dart';

class S_payments extends StatefulWidget {
  const S_payments({Key? key}) : super(key: key);

  @override
  State<S_payments> createState() => _S_paymentsState();
}

class _S_paymentsState extends State<S_payments> {
  ...
  var data = [
    ...
    String type="all";
    void initState() {
    credituser = getcredituserforshopkeeper(usermodel!.id,type);
       NotificationLen= getNotificationLength(usermodel!.id,"shopkeeper");
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      actions: [
        GestureDetector(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=> Shopkeeper_notification()));
          },
          child: Badge(
            badgeContent: 
              ...
              itemBuilder: (context,index)
              {
                return Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              Navigator.push(context, MaterialPageRoute(builder: (context)=> S_U_O_details(id: snapshot.data![index].id,)));
                                            },
                                            child: Container(
