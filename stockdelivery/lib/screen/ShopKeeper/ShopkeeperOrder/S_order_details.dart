...
class S_orderDetails extends StatefulWidget {
  final userorders userorder;
  final String type;
  const S_orderDetails({Key? key, required this.userorder, required this.type}) : super(key: key);

  @override
  State<S_orderDetails> createState() => _S_orderDetailsState(userorder,userorder.order_status,userorder.id);
}

class _S_orderDetailsState extends State<S_orderDetails> {
  int? id;
  userorders? userorder ;
  _S_orderDetailsState(this.userorder,this.orderstatus,this.id);
  var data=[
    "active",
    "cancelled",
    "Packed",
...
//   void check()
//   async{
// //status = await Rateapi.checkalreadyrated(id.toString(),orderUser!.id.toString(),usermodel!.id.toString());
// setState(() {
...
//   }
  @override
  void initState() {
   userwithproduct= getorderproductsfromShopkeeperside(id!,widget.type);
    super.initState();
  }
  @override
